...
def extractFeatures(Wmatrix, methodScore, clustersize):
...
path_to_genes_cluster6 = "E:/CCLE manusscript/Data/Cluster results/Results used for paper/NMF clustering results/Genes_cluster6_k8_nrun40.csv"
cluster6_feature_genes = pd.read_csv(path_to_genes_cluster6,sep=',',index_col=False)
path_to_genes_cluster7 = "E:/CCLE manusscript/Data/Cluster results/Results used for paper/NMF clustering results/Genes_cluster7_k8_nrun40.csv"
...
pickle_in = open("E:/CCLE manusscript/Data/Cluster results/Results used for paper/NMF clustering results/Wmatric_40runs_pickle","rb")
Wmatrix=pickle.load(pickle_in)
pickle_in1=open("E:/CCLE manusscript/Data/Cluster results/Results used for paper/NMF clustering results/Hmatrix_40runs.pickle","rb")
...
# Load the meta data
file_microsatellite="E:/CCLE manusscript/Data/Cluster results/Results used for paper/Microsatellite_Instability_Info.csv"
...
scored_matrix_maximum_genes,sel_genes,features_per_cluster_genes=extractFeatures(genes_wmatrix,'Max_Kim_Score',8)
scored_matrix_maximum_cpg,sel_cpg,features_per_cluster_cpg=extractFeatures(cpg_wmatrix,'Max_Kim_Score',8)
...
testdf=methylationdata.iloc[features_per_cluster_cpg[6],:]
sns.clustermap(testdf)
#test2=gene_expression_data.iloc[features_per_cluster_genes[6],:]
#sns.clustermap(test2)